...
class InputAllergiesScreen extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        ...
        return Scaffold(
            appBar: AppBar(title: const Text('알레르기기 선택')),
            body: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    const Padding(
                        padding: EdgeInsets.all(16),
                        child: Text('가지고 있는 알레르기 있다면면 선택해주세요.'),
                    ),
                    Wrap(
                        children: allergyList.map((a) {
                            ...
                            return SelectableButton(
                                text: a,
                                isSelected: selected,
                                onTap: () => provider.toggleAllergy(a),
                            );
                        }).toList(),
                    ),
                    const Spacer(),
                    Row(
                        ...
                        children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () => Navigator.pushNamed(context, '/input_dislikes'),
                            ),    
                        ],
                    )
                ],
